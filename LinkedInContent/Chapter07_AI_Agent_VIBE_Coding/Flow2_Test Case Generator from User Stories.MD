## Problem Statement
you will get jira ticket based on the jira ticket, You need to featch content after featch the content you need to generate test case based on template which i am going to give you.

## Template 
1.Jira Id
2.Test Case Template 
3.Test Case Generated
